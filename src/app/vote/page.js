...
export default function Vote() {
    ...
    function getOption(option) {
        switch(option){
            case "fabricio": return { name: "Cachorro", image:"https://www.designi.com.br/images/preview/11458656.jpg"};
            case "catinga": return { name: "Cachorro", image:"https://img.freepik.com/fotos-premium/desenho-de-meninas-para-colorir_996136-2135.jpg"};
            default: return DEFAULT_OPTION;
        }
    }

    function btnVoteClick(option) {
            ...
            <div className="container col-xxl-8 px-4 py-5">
                ...
                <div className="row flex-lg-row-reverse align-items-center g-1 py-5">
                    ...
                    <div className="col-5">
                        ...
                        <img alt='primeiro candidato' src={option2.image} className="d-block mx-auto img-fluid rounded" width={250} height={250} />
                        {
                            showVotes > 0 || voting.maxDate < (Date.now() / 1000)
                                ...
                                : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={() => btnVoteClick(2)}>Quero que saia esse</button>
                        }
                    </div>
                    <div className="col-5">
                        <h3 className="my-2 d-block mx-auto" style={{ width: 250 }}>
                        ...
                        <img alt='segundo candidato' src={option1.image} className="d-block mx-auto img-fluid rounded" width={250} height={250} />
                        {
                            showVotes > 0 || voting.maxDate < (Date.now() / 1000)
                                ...
                                : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={() => btnVoteClick(1)}>Quero que saia esse</button>
                        }
                    </div>
                </div>
                <div className="row align-items-center">
